...
class Pager {
     ...
     * @return string
     */
    public function execute(int $count, int $prepage = self::LIMIT, int $npage = 1 , string $url = '/',
                          bool $isAjax = false , bool $default_style = false ,
                          string $endhtml = "", int $show_end = 1): string {
     ...
     * @return string
     */
    protected function pager_html(int $page_num, string $url, int $page, bool $default_style = false,
                                string $endhtml = '', bool $show_end = false): string {
        if($page_num >= 1 ){
