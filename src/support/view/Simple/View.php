...
class View extends Template {
    public  array $view            = array(); //视图变量
    private array $template_arr    = array(); //视图存放器
    private array $remove_tpl_arr  = array(); //待移除
     ...
     * @param object|int|boolean|array|string|null $value value值
     */
